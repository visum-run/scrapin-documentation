...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="user"
    href="/endpoint/v1/person/match"
  >
    Extract fresh profile data directly in real-time from first name, last name,
    company, email.
  </Card>
</CardGroup>
...
3. **Enrich** - Use [Person Profile Data](/endpoint/v1/person/profile) or [Person Match](/endpoint/v1/person/match) to get the freshest data for the profiles you need
