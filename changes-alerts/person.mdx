...
```
GET /api/v1/alerts/*endpoint*?apikey=YOUR_API_KEY
POST /api/v1/alerts/*endpoint*?apikey=YOUR_API_KEY
```
...
```bash
curl "https://api.scrapin.io/api/v1/alerts/url?apikey=YOUR_API_KEY" \
...
<Card title="GET /api/v1/alerts/url">
...
<Card title="POST /api/v1/alerts/url">
...
<Card title="GET /api/v1/alerts/subscriptions">
...
<Card title="POST /api/v1/alerts/subscribe">
...
<Card title="POST /api/v1/alerts/unsubscribe">Deactivate a subscription.</Card>
...
<Card title="GET /api/v1/alerts/deliveries">
